...
class TransactiontypeMaintenance(models.Model):
    ...
    document_type = models.ForeignKey('DocumentTypeMaintenance', default=0, verbose_name="Document Type",on_delete=models.CASCADE)
    is_active = models.BooleanField()
    is_utility = models.BooleanField()    
    send_to_account = models.BooleanField()
...
class WorkflowApprovalRuleGroupMaintenance(models.Model):
    ...
    submitter_group = models.ForeignKey('EmployeeGroupMaintenance',related_name="submitter_group", verbose_name="Submitter Group",on_delete=models.CASCADE, null=True, blank=True, )
