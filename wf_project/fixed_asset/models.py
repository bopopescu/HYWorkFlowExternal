...
class AssetMaster(models.Model):
    ...
    asset_type_id = models.ForeignKey(AssetType, on_delete = models.CASCADE, null=True, blank=True)
    asset_category_id = models.ForeignKey(AssetCategory, on_delete = models.CASCADE, null=True, blank=True)
    tax_id = models.ForeignKey(Tax, on_delete = models.CASCADE, null=True, blank=True)
    class_type_id = models.ForeignKey(ClassType, on_delete = models.CASCADE, null=True, blank=True)
